...
# Import GDS data
genofile <- seqOpen("../output/cohort_biallelicSNPs_HardFiltered_WithMissingness_SOSFERTsamples_GTfiltered.gds")

# PCA
pca <- snpgdsPCA(genofile)

# Export table of PC percentage
data.frame(PC=1:7, varprop = pca$varprop[1:7]*100) %>% write.csv("../output/pc_pct_SOSFERTsamples.csv")
...
write.csv(tab, "../output/pc_eigenscores_SOSFERTsamples.csv")
