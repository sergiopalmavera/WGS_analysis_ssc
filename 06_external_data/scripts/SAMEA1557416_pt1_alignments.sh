...
sample_id=SAMEA1557416
fq1_link=ftp://ftp.sra.ebi.ac.uk/vol1/fastq/ERR173/ERR173181/ERR173181_1.fastq.gz
fq2_link=ftp://ftp.sra.ebi.ac.uk/vol1/fastq/ERR173/ERR173181/ERR173181_2.fastq.gz

# Manually define fastq and bam file names
base_nm=SAMEA1557416_ERR173181
...
# Make alignments ----------------------------------------------------
echo "### bwa-mem"
time bwa mem -t 20 -M $REF/Sus_scrofa.Sscrofa11.1.dna.toplevel.fa $TMP/$tmp_sub/$new_R1_clean $TMP/$tmp_sub/$new_R2_clean | samtools view -@ 20 -bS - > $TMP/$tmp_sub/$bam
