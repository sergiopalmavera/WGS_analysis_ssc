...
anti_join(
  ...
  write.table(here("00_analysis/data/sosfert_common_private_snps/sosfert_private_snps_PI.tab"))
...
anti_join(
  ...
  write.table(here("00_analysis/data/sosfert_common_private_snps/sosfert_private_snps_LW.tab"))

```

```{r}

here("00_analysis/data/sosfert_common_private_snps/sosfert_private_snps_LW.tab") %>% 
  vroom(delim = " ") %>% nrow()
