...
pop_vcf=../output/cohort_biallelicSNPs_HardFiltered_WithMissingness_filtered_sire_lines_all_sites.vcf

echo "# subset main vcf for population (exclude ref alleles)"
$bcftools/bcftools view --samples-file ../../sample_info/sire_lines.txt $in_vcf -o $pop_vcf
printf "\n\n"
