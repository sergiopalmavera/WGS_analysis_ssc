...
$gatk/gatk SelectVariants \
	...
	-L $path_to_intervals/sosfert_private_snps_PI.intervals \
	-O ../output/cohort_biallelicSNPs_HardFiltered_WithMissingness_SOSFERTsamples_GTfiltered_private_PI.vcf
